import { apiGet } from "../api.js?v=20260904b";
import { PLAYER_MATCH_LIMIT } from "../config.js?v=20260904b";
import { championIcon } from "../assets.js?v=20260904b";
import { $, escapeHtml, kdaClass, normalizeRoleKey, tierClass } from "../utils.js?v=20260904b";
import { renderLoading, switchView } from "../view.js?v=20260904b";
import { playerMatchCard } from "../components/playerMatchCard.js?v=20260904b";
import { bindExpanders } from "../components/scoreboard.js?v=20260904b";
