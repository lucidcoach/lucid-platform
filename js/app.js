import { loadGameAssets } from "./assets.js?v=20260904b";
import { $ } from "./utils.js?v=20260904b";
import { switchView } from "./view.js?v=20260904b";
import { loadRecent } from "./pages/recentMatches.js?v=20260904b";
import { state } from "./state.js?v=20260904b";
import { openPlayer, searchPlayers } from "./pages/playerSearch.js?v=20260904b";
