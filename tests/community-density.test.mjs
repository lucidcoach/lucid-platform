...
assert.match(profile, /profile-summary-panel>\.profile-rank-switcher\{margin:10px 0 0;padding:0;border:0;background:transparent\}/);
assert.match(profile, /role-tier-main\{grid-template-columns:minmax\(104px,1fr\) 104px 46px!important;gap:4px!important\}/);
