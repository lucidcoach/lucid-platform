...
assert.match(mileage, /mileage-progress-card.*일일 퀘스트.*q\.period==="daily".*획득 상한.*mileage-progress-weekly.*주간 퀘스트.*q\.period==="weekly"/s);
assert.match(mileageCss, /\.mileage-progress-grid\{[^}]*grid-template-columns:repeat\(2/);
assert.match(mileageCss, /\.mileage-progress-weekly\{grid-column:1\/-1\}/);
