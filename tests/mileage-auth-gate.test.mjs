...
assert.match(entry, /pages\/mileage\.js\?v=20260913adminux1/);
assert.match(page, /styles\.css\?v=20260913adminux1/);
assert.match(page, /app-report6\.js\?v=20260913adminux1/);
