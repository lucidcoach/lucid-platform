...
assert.match(entry, /pages\/mileage\.js\?v=20260911dryrun1/);
assert.match(page, /styles\.css\?v=20260911titleicon1/);
assert.match(page, /app-report6\.js\?v=20260911titleicon1/);
