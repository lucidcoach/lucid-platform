...
export const state = {
  ...
  siteSettings: {
    maintenance: true,
    maintenanceTitle: "현재 코칭 시스템 점검 중입니다.",
    maintenanceMessage: "사이트 내 코칭 신청 및 예약 기능은 현재 이용할 수 없습니다. 코칭 문의를 남겨주시면 운영진이 가능한 일정을 안내합니다.",
    maintenanceCta: "코칭 문의하기",
  },
  siteSettingsLoadState: "idle",
  adminOperations: null,
  adminOperationsLoadState: "idle",
  cropSourceImage: "",
  cropTarget: null,
  coachProfile: null,
  ...
  coachCalendarEvents: [],
  coachCalendarLoadState: "idle",
  coachCalendarLoadKey: "",
  coachCalendarCoachKey: "",
  coachCalendarError: "",
  refundRequests: [],
  adminRefundRequests: [],
