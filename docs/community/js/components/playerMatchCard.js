...
import { escapeHtml, focusKda, kdaClass, normalizeMode, relativeTime, scoreClass, tierClass } from "../utils.js?v=20260904v";
import { renderInventoryGrid, renderProfileRuneSpells, renderBuildSummary } from "./loadout.js?v=20260904v";
import { scoreboard } from "./scoreboard.js?v=20260904v";
...
export function playerMatchCard(match, userId) {
  ...
  return `<article class="personal-match ${won ? "win" : "loss"}${special ? " special-match" : ""}">
    <div class="personal-summary">
      ...
      <div class="personal-combat-cluster">
