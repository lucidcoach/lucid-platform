...
import { openPlayer, searchPlayers } from "./pages/playerSearch.js?v=20260909replay1";
...
import { bindRankingPage, loadRankings } from "./pages/ranking.js?v=20260909currentui1";
import { hasCommunityAdminAccess, renderCommunityAdmin, syncAdminAccess } from "./pages/communityAdmin.js?v=20260910queues1";
import { renderMileage } from "./pages/mileage.js?v=20260910series1";
...
import { loadLiveMatch } from "./pages/liveMatch.js?v=20260909currentui1";
