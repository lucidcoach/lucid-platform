...
function renderPreview(gameId) {
  ...
  root.innerHTML = `<div class="current-preview">
    ...
    <div class="current-preview-summary"><div><strong class="blue">BLUE TEAM</strong><span>VS</span><strong class="red">RED TEAM</strong></div><p>${startText(game.startedAt)} ${game.startTimeSource === "game" ? "시작" : "라인업 확정"} · ${elapsedText(game.startedAt)}</p></div>
